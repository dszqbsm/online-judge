...
func UpdateCaseDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateCaseDetailRequest
		...
		l := cases.NewUpdateCaseDetailLogic(r.Context(), svcCtx)
		resp, err := l.UpdateCaseDetail(&req)
