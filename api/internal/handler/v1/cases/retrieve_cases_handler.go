...
func RetrieveCasesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RetrieveCasesRequest
		...
		l := cases.NewRetrieveCasesLogic(r.Context(), svcCtx)
		resp, err := l.RetrieveCases(&req)
