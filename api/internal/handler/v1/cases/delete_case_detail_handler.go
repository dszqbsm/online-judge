...
func DeleteCaseDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteCaseDetailRequest
		...
		l := cases.NewDeleteCaseDetailLogic(r.Context(), svcCtx)
		resp, err := l.DeleteCaseDetail(&req)
