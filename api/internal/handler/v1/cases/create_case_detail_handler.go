...
func CreateCaseDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateCaseDetailRequest
		...
		l := cases.NewCreateCaseDetailLogic(r.Context(), svcCtx)
		resp, err := l.CreateCaseDetail(&req)
