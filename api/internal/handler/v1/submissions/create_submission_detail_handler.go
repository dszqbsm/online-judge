...
func CreateSubmissionDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateSubmissionDetailRequest
		...
		l := submissions.NewCreateSubmissionDetailLogic(r.Context(), svcCtx)
		resp, err := l.CreateSubmissionDetail(&req)
