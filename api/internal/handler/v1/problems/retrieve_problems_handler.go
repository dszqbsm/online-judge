...
func RetrieveProblemsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RetrieveProblemsRequest
		...
		l := problems.NewRetrieveProblemsLogic(r.Context(), svcCtx)
		resp, err := l.RetrieveProblems(&req)
