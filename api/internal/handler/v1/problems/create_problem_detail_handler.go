...
func CreateProblemDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateProblemDetailRequest
		...
		l := problems.NewCreateProblemDetailLogic(r.Context(), svcCtx)
		resp, err := l.CreateProblemDetail(&req)
